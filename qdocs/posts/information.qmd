...
1. `draw`, `model` and `density` specifically refer to quantities related to $q_X$ as shown in the table. The plain-text model, density etc. refer to the general concepts.
