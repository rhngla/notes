...
These set of [notes by Drew Wilimitis](https://drewwilimitis.github.io/Manifold-Learning/) contain python implementation of common methods. 
...
- Isomap: preserve pairwise geodesic distances (evaluated through nearest neighbor hops, using  some common metric)
- Diffusion maps: consider a notion of reachability of distant points by constructing a diffusion process [@coifman2005geometric; @de2008introduction]
- Laplacian eigenmaps, T-sne, Umap etc. are other nonlinear methods
- Similarities and distances - see @ganea2019non
...
Identifying appropriate metric for to measure similarity between cells is a fundamental challenge, and at the core of investigations such as the one in @skinnider2019evaluating and @cooley2019novel.
 ...
 - Discuss @wolf2019paga, who adapt diffusion maps for scRNA-seq analysis.
