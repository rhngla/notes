...
I expect that particular masking patterns, whether masking retains dependencies when stacked, sparsity of the attention matrix (and of $K$, $Q$, $V$ matrices) are important questions for specific applications. 
